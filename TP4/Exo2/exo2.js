...
lightDirectional.castShadow = true; // Enable shadow casting
...
class Figure {
  ...
  createBody() {
    ...
    bodyMain.castShadow = true; // Enable shadow casting
    bodyMain.receiveShadow = true; // Enable shadow receiving
  ...
  createArms() {
    ...
    for (let i = 0; i < 2; i++) {
      ...
      arm.castShadow = true; // Enable shadow casting
      arm.receiveShadow = true; // Enable shadow receiving
      const m = i % 2 === 0 ? 1 : -1;
  ...
  createEyes() {
    ...
    for (let i = 0; i < 2; i++) {
      ...
      eye.castShadow = true; // Enable shadow casting
      eye.receiveShadow = true; // Enable shadow receiving
      const m = i % 2 === 0 ? 1 : -1;
  ...
  createLegs() {
    ...
    for (let i = 0; i < 2; i++) {
      ...
      leg.castShadow = true; // Enable shadow casting
      leg.receiveShadow = true; // Enable shadow receiving
      const m = i % 2 === 0 ? 1 : -1;
