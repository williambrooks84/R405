...
window.addEventListener('click', (event) => {
  pointer.x = (event.clientX / window.innerWidth) * 2 - 1; //entre -1 et 1
  pointer.y = - (event.clientY / window.innerHeight) * 2 + 1; //entre -1 et 1
 ...
 if (intersects.length > 0) {
    flying = !flying; //Arrêter le vol si on clique sur le vaisseau
  }
});
